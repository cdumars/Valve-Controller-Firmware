...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LOX_PG_Pin FUEL_PG_Pin */
  GPIO_InitStruct.Pin = LOX_PG_Pin|FUEL_PG_Pin;
  ...
  /*Configure GPIO pins : STATUS_G_Pin STATUS_R_Pin STATUS_B_Pin */
  GPIO_InitStruct.Pin = STATUS_G_Pin|STATUS_R_Pin|STATUS_B_Pin;
  ...
  /*Configure GPIO pins : ENCD2_A_Pin ENCD2_B_Pin */
  GPIO_InitStruct.Pin = ENCD2_A_Pin|ENCD2_B_Pin;
